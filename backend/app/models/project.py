...
class Project:
    ...
    graph_build_checkpoint: Optional[Dict[str, Any]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "graph_build_checkpoint": self.graph_build_checkpoint,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Project':
        ...
        return cls(
            ...
            graph_build_checkpoint=data.get('graph_build_checkpoint'),
