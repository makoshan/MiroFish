              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                ...
                <div class="range-wrapper">
                  <input 
                    ...
                    :style="{ '--percent': (autoGeneratedRounds > 10 ? ((customMaxRounds - 10) / (autoGeneratedRounds - 10)) * 100 : 0) + '%' }"
                  />
                  <div class="range-marks">
                    <span>10</span>
                    <span
                      v-if="autoGeneratedRounds > 10"
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">若需快速验证链路，建议切换到自定义 10 轮模式，以便更快看到结果 ➝</p>
                    </div>
                  </div>
                </div>
              </div>
...
// 模拟轮数配置
const useCustomRounds = ref(true) // 默认使用自定义轮数，降低本地调试成本
const customMaxRounds = ref(10)   // 默认推荐10轮
...
const autoGeneratedRounds = computed(() => {
  ...
  return Math.max(calculatedRounds, 10)
})
